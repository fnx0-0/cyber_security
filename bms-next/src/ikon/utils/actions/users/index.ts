...
export const getUsersByGroupName = async (
  ...
  const resp = await fetch(
    `${process.env.NEXT_BASE_PATH}/api/user/group/${groupName}`,
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
...
export const getUsersByRoleName = async (
  ...
  // Fetch API with cookies
  const resp = await fetch(
    `${process.env.NEXT_BASE_PATH}/api/user/role/${roleName}`,
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
...
export const getUserRoles = async (userId?: string): Promise<any> => {
  ...
  // Fetch API with cookies
  const resp = await fetch(
    `${process.env.NEXT_BASE_PATH}/api/user/${userId}/roles`,
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
...
export const getUserGroups = async (userId?: string): Promise<any> => {
  ...
  // Fetch API with cookies
  const resp = await fetch(
    `${process.env.NEXT_BASE_PATH}/api/user/${userId}/groups`,
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
