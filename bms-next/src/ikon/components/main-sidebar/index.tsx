...
import { BrainCircuit,ShieldCheck , BrainCog, ChartPie, Code, Cpu, Dock, DollarSign, FileText, Headset, List, Database, Building } from "lucide-react";
    ...
    >
      <SidebarHeader className="border-b">
        <SidebarMenu className="justify-center h-9">
          <SidebarMenuItem>
            <AccountSwitcher accounts={accounts} activeAccountDetails={activeAccount} />
          </SidebarMenuItem>
        </SidebarMenu>
      </SidebarHeader>
      <SidebarContent>
