                        ...
                        >
                            ...
                            >
                                <Avatar className="w-32 h-32">
                                    ...
                                    <AvatarFallback>{profileData.USER_NAME?.match(/\b([A-Z])/g)?.join('')}</AvatarFallback>
                                </Avatar>
                                {isHovering && (
                                    <div className="w-full h-full rounded-full bg-accent text-accent-foreground absolute top-0 flex justify-center items-center opacity-50"><Upload /></div>
                                )}
                            </div>
                        </ImageCropperProvider>
