                        ...
                        <div className=' flex flex-col gap-3 h-full overflow-y-auto pl-4'>
                            {
                                allApps.map((item: any, index: number) => (
                                    ["Base App", "SSD NEW", "Customer Support - Microservice", "IKON DevZone", "Water Management - TCS"].includes(item.SOFTWARE_NAME)
                                        ?
                                        null
                                        :
                                        (<div key={index}>
                                                ...
                                                <div className='flex flex-row gap-5'>
                                                    <div className='self-center'>
                                                        <div className='w-20 h-14'>
                                                            <img
                                                                src={imageMap[item.SOFTWARE_NAME] || "/assets/images/Slider-1-D.svg"}
                                                                // width={100}
                                                                // height={100}
                                                    ...
                                                    <div className='flex flex-col'>
                                                        <h1 className='text-xl font-semibold'>{item.SOFTWARE_NAME}</h1>
