  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <h1 className="text-2xl sm:text-3xl font-bold">Building Management Dashboard</h1>
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-1">
                      <span className="text-sm font-medium">Lighting Efficiency</span>
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-1">
                      <span className="text-sm font-medium">Overall Energy Rating</span>
        ...
        <TabsContent value="occupancy" className="space-y-4">
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <Card className="col-span-full">
              ...
              <CardContent className="h-[300px]">
                <ResponsiveContainer width="100%" height="100%">
                  <EChartAreaOccupancyComponent occupancyData={occupancyData} chartConfiguration={chartOptionForOccupancyData} />
                </ResponsiveContainer>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  <div>
                    <div className="flex items-center justify-between mb-1">
                      <span className="text-sm font-medium">Zone A (Offices)</span>
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-1">
                      <span className="text-sm font-medium">Zone B (Meeting Rooms)</span>
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-1">
                      <span className="text-sm font-medium">Zone C (Common Areas)</span>
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-1">
                      <span className="text-sm font-medium">Zone D (Technical)</span>
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-sm font-medium">Average Daily Occupancy</span>
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-sm font-medium">Predicted Tomorrow</span>
