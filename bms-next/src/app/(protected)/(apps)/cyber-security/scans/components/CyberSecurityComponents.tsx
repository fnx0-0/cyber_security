...
import CustomisedLoading from "@/app/(protected)/(apps)/cyber-security/misc/components/CustomisedLoading"//"@/components/CustomisedLoading";
...
const comps: AIAgent[] = [
  ...
  },
  {
    ...
    route: "/cyber-security/scans/penTest",
  },
  {
          ...
          >
            ...
            <div className="mt-6 flex space-x-3">
              ...
              <button
                ...
                className="flex-1 btn-primary dark:bg-dark-bg Tertiary btn-primary"
              >
