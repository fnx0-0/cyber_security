...
const tenderSchema = z.object({
  ...
  bidSecurityValidity: z.number().optional(),

  // Submission Requirements
  submissionMethod: z.enum(["electronic", "physical", "both"]).optional(),
  copiesRequired: z.number().optional(),
  formatRequirements: z.string().optional(),
  supportingDocuments: z.string().optional(),
  preQualificationDocs: z.string().optional(),
          ...
          try {
            ...
            Object.entries(formData).forEach(([key, value]) => {
              ...
              if (typeof value === "object" && value?.resourceName) {
                ...
                form.setValue(key as keyof CreateDraftFormData, [file]); // Setting value for file input
              } else {
                // Normal field handling
                form.setValue(key as keyof CreateDraftFormData, value);
              }
            });
          } catch (error) {
            ...
            <CardContent>
              <div className="grid grid-cols-3 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  />
                  {form.formState.errors.biddingDocs && (
                    <p className="text-red-500 text-sm">
                      {form.formState.errors.biddingDocs?.message?.toString()}
                    </p>
                  )}
                </div>
                ...
                <div className="space-y-2">
                  ...
                  />
                  {form.formState.errors.techSpecsDocs && (
                    <p className="text-red-500 text-sm">
                      {form.formState.errors.techSpecsDocs?.message?.toString()}
                    </p>
                  )}
                </div>
                ...
                <div className="space-y-2">
                  ...
                  />
                  {form.formState.errors.draftContract && (
                    <p className="text-red-500 text-sm">
                      {form.formState.errors.draftContract?.message?.toString()}
                    </p>
                  )}
                </div>
                ...
                <div className="space-y-2">
                  ...
                  />
                  {form.formState.errors.billQuantities && (
                    <p className="text-red-500 text-sm">
                      {form.formState.errors.billQuantities?.message?.toString()}
                    </p>
                  )}
                </div>
                ...
                <div className="space-y-2">
                  ...
                  {form.formState.errors.specialInstructions && (
                    <p className="text-red-500 text-sm">
                      {form.formState.errors.specialInstructions?.message?.toString()}
                    </p>
                  )}
                </div>
              </div>
