...
function getColumns(serviceIdWiseDetails: serviceIdWiseDetails, form : UseFormReturn<{pollingInterval: string; serviceChkb: string[];}, any, undefined>){
...
const DevicePollingIntervalModal : FC<DevicePollingIntervalProps> = ({open, close, deviceId, refresh, serviceIdWiseDetails}) => {
    ...
    const columns = getColumns(serviceIdWiseDetails, form);
