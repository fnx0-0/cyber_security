        ...
        <>
            <div className="w-full h-full flex flex-col gap-3">
                ...
                <div className='flex-grow overflow-y-auto pr-2'>
                    ...
                    <Card className="w-full mt-3 p-4">
                        <EChartBarChart chartData={ref.sectorRevenueChartData} configurationObj={barChart_configurationObj3} />
                    </Card>
                    <div className="grid grid-cols-6 gap-4 w-full">
                        <div className="col-span-3 w-full">
                            <Card className="w-full mt-3 p-4">
                                <DonoutChart chartData={ref.PieChartData} chartConfiguration={donoutchart_configurationObj} />
                            </Card>
                        </div>
                        <div className="col-span-3 col-start-4">
                            <Card className="w-full mt-3 p-4">
