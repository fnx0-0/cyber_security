...
const LeadModal: React.FC<LeadModalProps> = ({ isOpen, onClose }) => {
  ...
  //getUserIdNameMapping().then(console.log);
...
//   async function getUserIdNameMapping(): Promise<
//     { value: string; label: string }[]
//   > {
//     const userDetailsMap: Record<string, UserDetails> =
//       await getUserIdWiseUserDetailsMap();

//     const userIdNameMapping: { value: string; label: string }[] = Object.keys(
//       userDetailsMap
//     ).map((userId) => ({
//       value: userId,
//       label: userDetailsMap[userId]?.userName || "",
//     }));

//     return userIdNameMapping;
//   }
          ...
          <div className="flex flex-col gap-4 max-h-[70vh] overflow-y-auto h-[85vh]">
            <div className="grid gap-1.5">
              <FormComboboxInput
                ...
                items={[
                  {
                    value: "f3a1b2c3i456789d0e123456789abcdef",
                    label: "Anushri Dutta",
                  },
                  {
                    value: "asdfg456c3i456789d0e11112367fgvkj",
                    label: "Prity Karmakar",
                  },
                ]}
                formControl={form.control}
