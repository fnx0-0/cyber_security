...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "align-middle border-b px-2 py-1 text-left text-sm  font-semibold [&:has([role=checkbox])]:pr-0 [&>[role=checkbox]]:translate-y-[1px]",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn(
      "px-2 py-1 text-sm  align-middle [&:has([role=checkbox])]:pr-0 [&>[role=checkbox]]:translate-y-[1px]",
      className
    )}
    {...props}
  />
